...
/* CreateNode will create a new ListNodePtr using a given void * newObj
 * CreateNode initializes ptrcount to 1 (since at least one pointer called this function)
 * CreateNode initializes the next field of the node to NULL
 * If CreateNode failed to malloc new memory for a ListNodePtr it returns NULL
 */
